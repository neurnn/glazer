...
namespace Glazer.Core.Models.Transactions
{
    public static class TransactionHelpers
    {
        ...
        public static void WriteWithoutValidation(this BinaryWriter Writer, Transaction Transaction)
        {
            ...
            Writer.Write(Header.TrxId); // Transaction Id AS EMPTY.
            Writer.Write(Header.TimeStamp);
            Writer.Write(Header.Sender);
            Writer.Write(Header.SenderSeal); // Sender Seal as EMPTY.
        ...
        public static void Write(this BinaryWriter Writer, Transaction Transaction, TransactionPackingOptions Options)
        {
            ...
            Writer.Write7BitEncodedInt(Transaction.ExpectedRecords.Count);
            foreach (var Expect in Transaction.ExpectedRecords)
            {
        ...
        {
            Writer.Write(Behaviour.CodeId.ToByteArray());
        ...
        public static TransactionBehaviour ReadTransactionBehaviour(this BinaryReader Reader)
        {
            ...
            Behaviour.CodeId = new Guid(Reader.ReadBytes(16));
